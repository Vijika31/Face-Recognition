...
class BankUi:
    ...
    def withdraw_money_page(self):
        ...
        self.frame.pack()
        data = pd.read_csv(r"C:\Users\viji\OneDrive\Desktop\mini\bank_details.csv")
    ...
    def user_account_transfer_transc(self):
        ...
        if int(self.entry11.get()) not in data['account_number'].values:
            ...
            update_data.to_csv(r"C:\Users\viji\OneDrive\Desktop\mini\bank_details.csv",index = None)
    ...
    def write_to_csv(self):
        ...
        name = self.uentry.get()
        password = self.pentry.get()
        with open(r"C:\Users\viji\OneDrive\Desktop\mini\bank_details.csv",'a', newline = '\n') as f:
            writer = csv.writer(f)
    ...
    def get_embeddings(self):
        ...
        detector = cv2.dnn.readNetFromCaffe(r"C:\Users\viji\OneDrive\Desktop\mini\deploy.prototxt",r"C:\Users\viji\OneDrive\Desktop\mini\res10_300x300_ssd_iter_140000.caffemodel")
        # load our serialized face embedding model from disk
        embedder = cv2.dnn.readNetFromTorch(r"C:\Users\viji\OneDrive\Desktop\mini\nn4.small2.v1.t7")
        ...
        f = open(r"C:\Users\viji\OneDrive\Desktop\mini\embeddings.pickle", "wb")
    ...
    def train_model(self):
        ...
        data = pickle.loads(open(r"C:\Users\viji\OneDrive\Desktop\mini\embeddings.pickle", "rb").read())
        le = LabelEncoder()
        ...
        f = open(r"C:\Users\viji\OneDrive\Desktop\mini\recognizer.pickle", "wb")
        f.write(pickle.dumps(recognizer))
        f.close()

        # write the label encoder to disk
        f = open(r"C:\Users\viji\OneDrive\Desktop\mini\le.pickle", "wb")
    ...
    def video_check(self):
        ...
        detector = cv2.dnn.readNetFromCaffe(r"C:\Users\viji\OneDrive\Desktop\mini\deploy.prototxt", 'face_detection_model/res10_300x300_ssd_iter_140000.caffemodel')
        #summary
        # load our serialized face embedding model from disk
        ...
        recognizer = pickle.loads(open(r"C:\Users\viji\OneDrive\Desktop\mini\recognizer.pickle", "rb").read())
        le = pickle.loads(open(r"C:\Users\viji\OneDrive\Desktop\mini\le.pickle", "rb").read())
